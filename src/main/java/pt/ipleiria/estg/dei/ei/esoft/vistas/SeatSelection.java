...
public class SeatSelection extends JFrame {
    ...
    public SeatSelection(Session session, Map<TicketType, Integer> selectedTickets) {
    ...
    private void confirmSeats() {
        ...
        // Open payment window
        PaymentWindow paymentWindow = new PaymentWindow(session,selectedTickets, seatList);
